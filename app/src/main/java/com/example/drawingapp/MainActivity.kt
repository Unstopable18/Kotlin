...
class MainActivity : AppCompatActivity() {
    ...
    private var mImgBtnCurrentColor: ImageButton? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mImgBtnCurrentColor=linearLayoutColors[1] as ImageButton
        mImgBtnCurrentColor!!.setImageDrawable(
            ContextCompat.getDrawable(this,R.drawable.pallet_pressed)
        )

        val undoImgBtn:ImageButton=findViewById(R.id.undoImgBtn)
        undoImgBtn.setOnClickListener{
        ...
        val brushImgBtn:ImageButton=findViewById(R.id.brushImgBtn)
        brushImgBtn.setOnClickListener{
            showBrushSizeChooserDialog()
        }

        val ibSave:ImageButton = findViewById(R.id.saveImgBtn)
...
//            }
    ...
    private fun showBrushSizeChooserDialog(){
        ...
        val smallBtn:ImageButton=brushDialog.findViewById<ImageButton>(R.id.smallBrushImgBtn)
        smallBtn.setOnClickListener{
            drawingView?.setSizeOfBrush(10.toFloat())
            brushDialog.dismiss()
        }
        val midBtn:ImageButton=brushDialog.findViewById<ImageButton>(R.id.midBrushImgBtn)
        midBtn.setOnClickListener{
            drawingView?.setSizeOfBrush(20.toFloat())
            brushDialog.dismiss()
        }
        val largeBtn:ImageButton=brushDialog.findViewById<ImageButton>(R.id.bigBrushImgBtn)
    ...
    fun colorClicked(view: View){
        if (view !== mImgBtnCurrentColor) {
            val imgBtn = view as ImageButton
            val colorTag = imgBtn.tag.toString()
            drawingView?.setColor(colorTag)
            imgBtn.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.pallet_pressed))
            mImgBtnCurrentColor?.setImageDrawable(
